...
from improved_agent import DQNAgent
from training import train_agent, evaluate_agent

def main():
    parser = argparse.ArgumentParser(description='Wood Cutting Optimization with DQN')
    parser.add_argument('--train', action='store_true', help='Train the agent')
    parser.add_argument('--evaluate', action='store_true', help='Evaluate the agent')
    parser.add_argument('--model_path', type=str, default='models/dqn_wood_cutting_final.pth', 
